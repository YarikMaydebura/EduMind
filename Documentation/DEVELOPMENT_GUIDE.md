...
```
Version: 1.0.0
Purpose: Setup instructions and coding conventions for Claude Code
```
...
|-------------|----------|-------|-----|
| Local | Docker Postgres | Docker Redis | Claude API (test key) |
| Staging | Supabase (staging) | Upstash (staging) | Claude API |
| Production | Supabase (prod) | Upstash (prod) | Claude API |
