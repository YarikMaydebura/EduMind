...
|------|-------|-----------|------------|-------------------|
| Learning Plan Generation | Advanced AI Model | Complex, requires deep understanding | ~4,000 | $0.06 |
| Lesson Plan Generation | Advanced AI Model | Detailed structure needed | ~3,000 | $0.045 |
| Quiz Generation | Advanced AI Model | Quality questions matter | ~2,000 | $0.03 |
| Homework Generation | Advanced AI Model | Personalization needed | ~1,500 | $0.022 |
| Homework Checking | Fast AI Model | Pattern matching | ~800 | $0.001 |
| Student Q&A (Hints) | Fast AI Model | Quick responses | ~500 | $0.0006 |
| Simple Feedback | Fast AI Model | Templated responses | ~300 | $0.0004 |
| Progress Analysis | Advanced AI Model | Complex analysis | ~2,000 | $0.03 |
| School Analytics | Advanced AI Model | Aggregated insights | ~3,000 | $0.045 |
...
const MODEL_CONFIG: Record<AITask, { model: string; maxTokens: number }> = {
  learning_plan: { model: 'advanced-model', maxTokens: 4000 },
  lesson_plan: { model: 'advanced-model', maxTokens: 3000 },
  quiz_generation: { model: 'advanced-model', maxTokens: 2500 },
  homework_generation: { model: 'advanced-model', maxTokens: 2000 },
  homework_check: { model: 'fast-model', maxTokens: 1000 },
  student_qa: { model: 'fast-model', maxTokens: 800 },
  feedback: { model: 'fast-model', maxTokens: 500 },
  progress_analysis: { model: 'advanced-model', maxTokens: 2000 },
  school_analytics: { model: 'advanced-model', maxTokens: 3000 },
};
...
const COST_PER_1K_TOKENS = {
  'advanced-model': { input: 0.003, output: 0.015 },
  'fast-model': { input: 0.00025, output: 0.00125 },
};
