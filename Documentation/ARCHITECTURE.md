...
Purpose: Technical architecture for Claude Code implementation
```
...
### ADR-006: AI Provider — Claude API (Anthropic)
**Decision:** Claude 3.5 Sonnet for complex tasks, Claude 3 Haiku for simple tasks.
...
│                                    │                                            │
│   ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐ ┌──────────┐            │
│   │ Anthropic│ │  Paddle  │ │  Resend  │ │  Sentry  │ │ Calendar │            │
│   │ (Claude) │ │(Payments)│ │ (Email)  │ │ (Errors) │ │  APIs    │            │
│   └──────────┘ └──────────┘ └──────────┘ └──────────┘ └──────────┘            │
│                                                                                  │
└──────────────────────────────────────────────────────────────────────────────────┘
```
...
|-------|----------|----------------|
| Claude 3.5 Sonnet | Learning plans, lesson plans, complex analysis | $3/$15 |
| Claude 3 Haiku | Quick Q&A, homework hints, simple checks | $0.25/$1.25 |
